...
public class Trainee_Search_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        courseList.add(new Course("PR001", "Prerequisite 1", new ArrayList<>(),
                "2023-08-01", "2023-08-30", "2023-07-01", "2023-07-31"));

        courseList.add(new Course("PR002", "Prerequisite 2", new ArrayList<>(),
                "2023-08-01", "2023-08-30", "2023-07-01", "2023-07-31"));

        courseList.add(new Course("C001", "Course 1", new ArrayList<>(),
                "2023-09-01", "2023-09-30", "2023-08-01", "2023-08-31"));
