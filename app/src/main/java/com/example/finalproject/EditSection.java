...
public class EditSection extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            TextView start_time_text = findViewById(R.id.starttimetv);
            TextView end_time_text = findViewById(R.id.eendtimetv);
            TextView days_text = findViewById(R.id.daystv);
            TextView room_text = findViewById(R.id.roomtv);
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(!dataBaseHelper.checkInstructor(EMAIL)){
                        Toast toast =Toast.makeText(EditSection.this, "The Instructor Doesn't Exist", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                    }
                    ...
                    if(!can){
                        Toast toast = Toast.makeText(EditSection.this, "The Instructor Has Another Class In This Time", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                    }
            ...
            room.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(start_time.getText().toString().isEmpty() || end_time.getText().toString().isEmpty() ||
                        ...
                        Toast toast =Toast.makeText(EditSection.this, "Select Time and Day First", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                    }
                    ...
                    if(sz != 0){
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(EditSection.this);
                        ...
                        Toast toast =Toast.makeText(EditSection.this, "No available rooms for your selection", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                }
            });
